...
class AdminDeleteDoctorPage extends StatefulWidget {
  @override
  State<AdminDeleteDoctorPage> createState() => _AdminDeleteDoctorPageState();
}

class _AdminDeleteDoctorPageState extends State<AdminDeleteDoctorPage> {
